...
import com.valdi.perfectrepapp.data.*
...
class MoveNet(private val interpreter: Interpreter, private var gpuDelegate: GpuDelegate?) :
    ...
    companion object {
        ...
        // TFLite file names.
        private const val LIGHTNING_FILENAME = "movenet_thunder_int8.tflite"
        private const val THUNDER_FILENAME = "movenet_thunder_float16.tflite"
